...
class _MenuState extends State<Menu> {
  List<MenuModel> menu = [
    MenuModel(icon: 'assets/images/sequetrics.png', title: ""),
    MenuModel(icon: 'assets/svg/home.svg', title: "Dashboard"),
    MenuModel(icon: 'assets/svg/profile.svg', title: "Profile"),
    MenuModel(icon: 'assets/svg/exercise.svg', title: "Hazard Log"),
                  ...
                  child: Row(
                    children: [
                      Padding(
                        ...
                        child: menu[i].icon.endsWith('.png')
                            ? Image.asset(
                                menu[i].icon,
